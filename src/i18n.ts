...
const zhCN: Dict = {
  ...
  fontSize: '正文字号',
  fontSizeHint: '用顶部 A− / A+ 随时调整正文字号；此处可一键恢复默认。',
  fontReset: '恢复默认字号',
  fontSmall: '小',
  fontNormal: '默认',
  fontLarge: '大',
...
const en: Dict = {
  ...
  fontSizeHint: 'Use the A− / A+ buttons in the header to adjust; reset to default here.',
